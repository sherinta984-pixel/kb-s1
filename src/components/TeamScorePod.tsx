    ...
    >
      ...
      <div className="relative w-full h-[78px] sm:h-[86px] z-20 mb-[-8px] group/banner">
        ...
        >
          ...
          <line x1="72" y1="6" x2="428" y2="6" stroke="#ffffff" strokeWidth="2" strokeOpacity="0.75" strokeLinecap="round" />

          {/* 8. Bottom Laser Emitter Horizon */}
          <line x1="72" y1="80" x2="428" y2="80" stroke={p.primary} strokeWidth="2.5" strokeOpacity="0.9" strokeLinecap="round" />

          {/* 9. Corner Targeting Reticles */}
        ...
        <div className="relative z-10 w-full h-full px-10 sm:px-16 flex items-center justify-center pointer-events-none">
          <h1
            className={`font-team-name font-black uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-b from-white via-slate-100 to-slate-200 drop-shadow-[0_2px_4px_rgba(0,0,0,1)] drop-shadow-[0_4px_16px_rgba(0,0,0,0.95)] ${nameSize} truncate max-w-[340px] sm:max-w-[420px] text-center leading-none`}
            title={displayName}
          >
            {displayName}
          </h1>
      ...
      >
        ...
        >
          ...
          <line x1="85" y1="14" x2="415" y2="14" stroke="#ffffff" strokeWidth="2.5" strokeOpacity="0.8" strokeLinecap="round" />

          {/* 12. Bottom Ion Accelerator Rail */}
          <line x1="95" y1="326" x2="405" y2="326" stroke={p.primary} strokeWidth="3" strokeOpacity="0.9" strokeLinecap="round" />

          {/* 13. Quad Precision HUD Corner Brackets */}
